...
export class WorkPackageResource extends HalResource {
  ...
  public getSchema() {
    if (this.formSchema) {
      ...
      return $q.when(this.formSchema);
    }

    return SchemaResource.fromWP(this).then((schema) => {
  ...
  public updateForm(payload) {
    ...
    this.form
      .then(form => {
        ...
        this.formSchema = form.$embedded.schema;
  ...
  public loadFormSchema() {
    return this.getForm().then(form => {
      const schema = this.formSchema = form.$embedded.schema;
      ...
      .then(form => {
        ...
        this.$links.updateImmediately(payload)
          .then((workPackage:WorkPackageResource) => {
            ...
            workPackage.getSchema().then((schema) => {
